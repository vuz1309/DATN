           ...
           <form method="post" action="" enctype="multipart/form-data">
             ...
             <div class="row">
               ...
               <div class="form-group col-md-6">
                   ...
                   <input value="{{old('occupation')}}" name="occupation"  type="text"  class="form-control" id="occupation" placeholder="">
               ...
               <div class="form-group col-md-6">
                ...
                <input value="{{old('address')}}" name="address"  type="text"  class="form-control" id="address" placeholder="">
