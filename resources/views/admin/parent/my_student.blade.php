...
<div class="content-wrapper">
 ...
 <section class="content-header">
   <div class="container-fluid">
     <div class="row mb-2">
       <div class="col-sm-6">
         <h1>Con cái phụ huynh: <span style="font-weight: bold;">{{$getParent->name}} {{$getParent->last_name}} </span></h1>
       </div>
            ...
            <div class="card-header"> Tìm học sinh</div>
             ...
             <div class="row">
                ...
                <div class="form-group col-md-3">
                    ...
                    <input name="id" value="{{Request::get('id')}}" type="text" class="form-control" id="id" placeholder="">
                  </div>
               <div class="form-group col-md-3">
                ...
                @if (!empty($getSearchStudents))
                 @foreach ($getSearchStudents as $value)
                   <tr>
                     ...
                     <td>
                       <a href="{{ url('admin/parent/assign_student_parent/' . $value->id . '/' . $parent_id) }}" class="btn btn-primary">Thêm </a>
                     </td>
                   </tr>
                 @endforeach
                 @endif
                  ...
                  @foreach ($getRecord as $value)
                    ...
                    @endif 
                      ...
                      <td>
                        ...
                        <a href="{{url('admin/parent/assign_student_parent_delete/' . $value->id)}}" class="btn btn-danger">Xóa</a>
