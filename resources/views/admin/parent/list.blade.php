                ...
                <div class="row">
                  <div class="form-group col-md-3">
                    ...
                    <div class="form-group col-md-3">
                      ...
                      <a href="{{url("admin/admin/list")}}" class="btn btn-success" style="margin-top:30px;">Làm mới</a>
                    </div>
                  ...
                  <tbody>
                    @foreach ($getRecord as $value)
                      ...
                      @endif 
                        ...
                        <td>
                          <a href="{{url('admin/parent/edit/' . $value->id)}}" class="btn btn-primary">Sửa</a>
                          <a href="{{url('admin/parent/delete/' . $value->id)}}" class="btn btn-danger">Xóa</a>
                          <a href="{{url('admin/parent/my-student/' . $value->id)}}" class="btn btn-warning">Học sinh</a>
                        </td>
                      </tr>
                    @endforeach
