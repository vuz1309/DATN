                ...
                <div class="row">
                  <div class="form-group col-md-3">
                    ...
                    <div class="form-group col-md-3">
                      ...
                      <option {{Request::get('type') == '' ? 'selected' : '' }} value="">Tất cả</option>
                        <option {{Request::get('type') == 'Lý thuyết' ? 'selected' : '' }} value="Lý thuyết">Lý thuyết</option>
                        <option  {{Request::get('type') == 'Thực hành' ? 'selected' : '' }} value="Thực hành">Thực hành</option>
                    </select>
                    ...
                    <div class="form-group col-md-3">
                      ...
                      <a href="{{url("admin/subject/list")}}" class="btn btn-success" style="margin-top:30px;">Làm mới</a>
                    </div>
                  ...
                  <tbody>
                    @foreach ($getRecord as $value)
                      <tr>
                        ...
                        <td>
                          <a href="{{url('admin/subject/edit/' . $value->id)}}" class="btn btn-primary">Sửa</a>
