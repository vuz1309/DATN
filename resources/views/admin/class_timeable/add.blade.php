              ...
              <form method="post" action="" enctype="multipart/form-data">
                ...
                <div class="row">
                  ...
                  <div class="form-group col-md-6">
                      ...
                      <input name="admission_number" value="{{old('admission_number')}}"  type="text" required class="form-control" id="admission_number" placeholder="">
                      <div style="color: red;">{{$errors->first('admission_number')}}</div>

                  </div>
                  <div class="form-group col-md-6">
                      <label for="roll_number">Roll number </label>
                      <input value="{{old('roll_number')}}" name="roll_number"  type="text"  class="form-control" id="roll_number" placeholder="">
                  ...
                  <div class="form-group col-md-6">
                      ...
                      <input value="{{old('caste')}}" name="caste"  type="text" required class="form-control" id="caste" placeholder="">
                  ...
                  <div class="form-group col-md-6">
                      ...
                      <input value="{{old('blood_group')}}" name="blood_group"  type="text"  class="form-control" id="blood_group" placeholder="">
                  ...
                  <div class="form-group col-md-6">
                      ...
                      <input value="{{old('weight')}}" name="weight"  type="text"  class="form-control" id="weight" placeholder="">
                  ...
                  <div class="form-group col-md-6">
                      ...
                      <input value="{{old('height')}}" name="height"  type="text"  class="form-control" id="height" placeholder="">
                  ...
                  <div class="form-group col-md-6">
                      ...
                      <select class="form-control"   name="status">
                        ...
                        <option {{old('status') == '0' ? 'selected' : ''}}  value="0">Đang học</option>
                        <option {{old('status') == '1' ? 'selected' : ''}} value="1">Ngưng học tập</option>
