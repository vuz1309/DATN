                ...
                <div class="row">
                  <div class="form-group col-md-3">
                    ...
                    <div class="form-group col-md-3">
                      ...
                      <input name="email" type="text" value="{{Request::get('email')}}" class="form-control" id="email" placeholder="">
                  ...
                  <tbody>
                    @foreach ($getRecord as $value)
                      <tr>
                        ...
                        <td>
                          <a href="{{url('admin/admin/edit/' . $value->id)}}" class="btn btn-primary">Sửa</a>
