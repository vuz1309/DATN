             ...
             <div class="row">
               <div class="form-group col-md-3">
                 ...
                 <div class="form-group col-md-3">
                   ...
                   <a href="{{url("admin/examinations/exam/list")}}" class="btn btn-success" style="margin-top:30px;">Làm mới</a>
                 </div>
               ...
               <tbody>
                 @foreach ($getRecord as $value)
                   <tr>
                     ...
                     <td>
                       <a href="{{url('admin/examinations/exam/edit/' . $value->id)}}" class="btn btn-primary">Sửa</a>
                       <a href="{{url('admin/examinations/exam/delete/' . $value->id)}}" class="btn btn-danger">Xóa</a>
                     </td>
                   </tr>
                 @endforeach
               </tbody>
