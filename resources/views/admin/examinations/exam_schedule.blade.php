            ...
            <div class="card-header">Tìm kiếm</div>
             ...
             <div class="row">
                 ...
                 <div class="form-group col-md-3">
                   ...
                   <a href="{{url("admin/examinations/exam_schedule")}}" class="btn btn-success" style="margin-top:30px;">Làm mới</a>
                 </div>
                    ...
                    <tbody>
                     ...
                     <tr>
                         ...
                         <td>{{$schedule['subject_name']}} 
                            <input name="schedule[{{$i}}][subject_id]" type="hidden" value="{{$schedule['subject_id']}}" />
                        </td>
                         <td>
                            <input value="{{$schedule['exam_date']}}"  name="schedule[{{$i}}][exam_date]" type="date" class="form-control">
                         </td>
                         <td>
                            <input   value="{{$schedule['start_time']}}" name="schedule[{{$i}}][start_time]"type="time" class="form-control">
                         </td>
                         <td>
                            <input  value="{{$schedule['end_time']}}" name="schedule[{{$i}}][end_time]" type="time" class="form-control">
                         </td>
                         <td>
                            <input  value="{{$schedule['room_number']}}" name="schedule[{{$i}}][room_number]" type="text" class="form-control">
                         </td>
                         <td>
                            <input  value="{{$schedule['full_marks']}}"  name="schedule[{{$i}}][full_marks]" type="text" class="form-control">
                         </td>
                         <td>
                            <input  value="{{ $schedule['passing_mark'] }}" name="schedule[{{$i}}][passing_mark]" type="text" class="form-control">
                         </td>
                        </tr>
                        @php
                        $i++;
