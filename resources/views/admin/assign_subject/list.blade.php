      ...
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-6" style="text-align: right;">
            <a href="{{ url('admin/assign_subject/add') }}">Thêm mới</a>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
                ...
                <div class="row">
                  <div class="form-group col-md-3">
                    ...
                    <div class="form-group col-md-3">
                      ...
                      <input  name="date" type="date" value="{{Request::get('date')}}" class="form-control" id="date" placeholder="">
   
                    </div>
                    <div class="form-group col-md-3">
                      <button type="submit" class="btn btn-primary" style="margin-top:30px;">Tìm kiếm</button>
                      <a href="{{url("admin/assign_subject/list")}}" class="btn btn-success" style="margin-top:30px;">Làm mới</a>
                    </div>
                  ...
                  <tbody>
                    @foreach ($getRecord as $value)
                      <tr>
                        ...
                        <td>
                          <a href="{{url('admin/assign_subject/edit_single/' . $value->id)}}" class="btn btn-primary">Sửa 1</a>
                          <a href="{{url('admin/assign_subject/edit/' . $value->id)}}" class="btn btn-primary">Sửa nhiều</a>
                          <a href="{{url('admin/assign_subject/delete/' . $value->id)}}" class="btn btn-danger">Xóa</a>
                        </td>
                      </tr>
                    @endforeach
