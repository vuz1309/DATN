      ...
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-6" style="text-align: right;">
            <a href="{{ url('admin/class/add') }}">Thêm mới</a>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
                  ...
                  <tbody>
                    @foreach ($getRecord as $value)
                      <tr>
                        ...
                        <td>
                          <a href="{{url('admin/class/edit/' . $value->id)}}" class="btn btn-primary">Sửa</a>
                          <a href="{{url('admin/class/delete/' . $value->id)}}" class="btn btn-danger">Xóa</a>
                        </td>
                      </tr>
                    @endforeach
