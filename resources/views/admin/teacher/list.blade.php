              ...
              <div class="container-fluid">
                  <div class="row mb-2">
                      ...
                      <div class="col-sm-6" style="text-align: right;">
                          <a class="btn btn-primary" href="{{ url('vAdmin/vTeacher/add') }}">Thêm mới</a>
                      </div>
                  </div>
              </div><!-- /.container-fluid -->
          </section>
                                  ...
                                  <div class="card-body">
                                      <div class="row">
                                          ...
                                          <div class="form-group col-md-3">
                                              ...
                                              <input name="mobile_number" value="{{ Request::get('mobile_number') }}"
                                          ...
                                          <div class="form-group col-md-3">
                                              <button type="submit" class="btn btn-primary" style="margin-top:30px;">Tìm
                                                  kiếm</button>
                                              <a href="{{ url('vAdmin/vTeacher/list') }}" class="btn btn-success"
                                      ...
                                      <tbody>
                                          @foreach ($getRecord as $value)
                                              <tr>
                                                  ...
                                                  <td>
                                                      <a href="{{ url('vAdmin/vTeacher/edit/' . $value->id) }}"
                                                          class="btn btn-primary">Sửa</a>
                                                      <a href="{{ url('vAdmin/vTeacher/delete/' . $value->id) }}"
