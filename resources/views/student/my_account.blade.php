                                  ...
                                  <div class="card-body">
                                      <div class="row">
                                          ...
                                          <div class="form-group col-md-6">
                                              ...
                                              <input readonly name="admission_number"
                                                  value="{{ $getRecord->admission_number }}" type="text" required
                                                  class="form-control" id="admission_number" placeholder="">
                                          ...
                                          <div class="form-group col-md-6">
                                              ...
                                              <input readonly name="admission_date"
                                                  value="{{ $getRecord->admission_date }}" type="date"
                                          ...
                                          <div class="form-group col-md-6">
                                              ...
                                              <input name="profile_pic" value="{{ $getRecord->profile_pic }}"
                                      ...
                                      <div class="form-group col-md-12">
                                          ...
                                          <input readonly name="email" value="{{ $getRecord->email }}" type="email"
                                              required class="form-control" id="email" placeholder="">
