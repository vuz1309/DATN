           ...
           <form method="post" action="" enctype="multipart/form-data">
             ...
             <div class="row">
               ...
               <div class="form-group col-md-6">
                   ...
                   <input  name="occupation" value="{{$getRecord->occupation}}"  type="text"  class="form-control" id="occupation" placeholder="">
               ...
               <div class="form-group col-md-6">
                ...
                <input  name="address" value="{{$getRecord->address}}"  type="text"  class="form-control" id="address" placeholder="">
               ...
               <div class="form-group col-md-6">
                   ...
                   <input name="profile_pic"  type="file"  class="form-control" id="profile_pic" placeholder="">
